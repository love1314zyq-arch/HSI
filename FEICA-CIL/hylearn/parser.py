...
def get_parser():
    ...
    # parser.add_argument("-fixed-memory", "--fixed-memory", action="store_true",default=False,
    ...
    parser.add_argument("--results-root", default=None, type=str,
                        help="Optional benchmark-specific output root.")
